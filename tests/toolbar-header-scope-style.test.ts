...
test('every web-ui toolbar-header rule requires a trailing interactive control', () => {
  // The dsh-web-ui settings-sheet polish used to compact the toolbar header
  ...
  // That compaction was removed in favour of the Bento foot card (fe4d18e),
  // so today no such selector exists. The rule stays as a guard: any selector
  // that comes back MUST be anchored to a header whose LAST CHILD is an
